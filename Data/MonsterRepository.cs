...
namespace assignment_sql_81clafra.Data
{
    ...
    public class MonsterRepository
    {
        ...
        static void UpdateMonster(Monster newMonster)
        {
            ...
            using (SQLiteCommand command = connection.CreateCommand()) // Generated with help from TabbyML/Qwen2.5-Coder-7B-Instruct
            {
                ...
                // Generated by TabbyML/Qwen2.5-Coder-7B-Instruct
                command.Parameters.AddWithValue("@name", newMonster.Name);
                command.Parameters.AddWithValue("@type", newMonster.Type);
                command.Parameters.AddWithValue("@dangerlevel", newMonster.DangerLevel);
                command.Parameters.AddWithValue("@id", newMonster.Id);
