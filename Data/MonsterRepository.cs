...
namespace assignment_sql_81clafra.Data
{
    ...
    public class MonsterRepository
    {
        ...
        static void ReadAllPersons()
        {
            ...
            string sqlCommandText = "SELECT Id, Namn, Ålder FROM Personer"; //  Generated by TabbyML/Qwen2.5-Coder-7B-Instruct
            ...
            while (reader.Read()) // Generated by TabbyML/Qwen2.5-Coder-7B-Instruct
            {
                ...
                Console.WriteLine($"Id: {id}, Namn: {name}, Ålder: {age}"); // Generated by TabbyML/Qwen2.5-Coder-7B-Instruct
            }
